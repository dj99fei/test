...
public class MainActivity extends BaseActivity implements MessageListFragment.OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTabHost.addTab(mTabHost.newTabSpec(TAG_MESSAGE).setIndicator(getFindIndicatorView(R.string.tab_text_message, R.drawable.ic_tab_find)), MessageListFragment.class, null);
